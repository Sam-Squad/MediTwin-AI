  ...
  return (
    <Card hover className="h-full flex flex-col justify-between p-5">
      <div className="flex items-start sm:items-center justify-between mb-6 gap-2 flex-col sm:flex-row">
        <div>
          <h3 className="text-base font-bold text-slate-800 dark:text-slate-100">Overall Health Score</h3>
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Based on lab reports & adherence</p>
        </div>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-around my-2 flex-1 gap-6">
        ...
        <div className="relative w-32 h-32 flex items-center justify-center shrink-0">
          ...
          <div className="absolute flex flex-col items-center justify-center">
            <span className="text-4xl font-black text-slate-800 dark:text-white tracking-tighter">{score}</span>
            <span className="text-[10px] text-slate-400 dark:text-slate-500 font-bold uppercase tracking-widest mt-0.5">Score</span>
          </div>
        </div>
        ...
        <div className="space-y-4 w-full sm:w-auto">
          <div className="bg-surface-50 dark:bg-slate-800/50 p-3 rounded-2xl border border-slate-100 dark:border-slate-700/50">
            <div className="text-[11px] font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1">Medicine Adherence</div>
      ...
      <div className="mt-6 pt-4 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between text-xs text-slate-500 dark:text-slate-400 font-medium">
